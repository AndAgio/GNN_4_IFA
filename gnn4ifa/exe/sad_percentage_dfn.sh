...
do
  start=$SECONDS
  python train.py --model="class_gin_2x100_mean" --train_scenario="existing" --train_topology="dfn" --epochs=10 --differential=0 --masking=0 --train_freq=$d --split_mode="percentage"
  python test.py --model="class_gin_2x100_mean" --train_scenario="existing" --train_topology="dfn" --test_scenario="existing" --test_topology="dfn" --differential=0 --masking=0 --train_freq=$d --split_mode="percentage"
