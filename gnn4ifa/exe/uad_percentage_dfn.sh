...
do
  start=$SECONDS
  python train.py --differential=1 --model="anomaly_gin_2x2x100" --percentile=0.985 --train_scenario="existing" --train_topology="dfn" --epochs=10 --masking=1 --train_freq=$d --split_mode="percentage"
  python test.py --differential=1 --model="anomaly_gin_2x2x100" --percentile=0.985 --train_scenario="existing" --train_topology="dfn" --test_scenario="existing" --test_topology="dfn" --masking=1 --train_freq=$d --split_mode="percentage"
