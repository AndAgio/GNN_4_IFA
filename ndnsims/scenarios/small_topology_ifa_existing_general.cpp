...
int main(int argc, char** argv)
{
  ...
  main_path << "results/dataset/IFA_4_Existing/small_topology/variable_attackers/" << attacker_frequency << "x/" << badNodes << "_attackers/"; //pit-size-" << run << ".txt";
  ...
  topologyReader.SetFileName("/home/enkeleda/ndnSIM/scenario-trials/scenarios/small_topology_general.txt");
  topologyReader.Read();
