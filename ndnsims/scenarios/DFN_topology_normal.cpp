...
namespace ns3 {
  ...
  void printPitCSSize(int sample_sim_time){
    ...
    fstream log;
    log.open("results/dataset/normal/DFN_topology/pit-size-5.txt", fstream::app);
    if (log.is_open()){
...
int main(int argc, char *argv[])
{
  ...
  topologyReader.SetFileName("/home/enkeleda/ndnSIM/scenario-trials/scenarios/DFN_topology.txt");
  topologyReader.Read();
  ...
  Ptr<Node> producers[6] = {Names::Find<Node>("Prod1"), Names::Find<Node>("Prod2"), Names::Find<Node>("Prod3"), Names::Find<Node>("Prod4"), Names::Find<Node>("Prod5"), Names::Find<Node>("Prod6")};
  Ptr<Node> consumers[8] = {Names::Find<Node>("Cons1"), Names::Find<Node>("Cons2"), Names::Find<Node>("Cons3"), Names::Find<Node>("Cons4"),
                          Names::Find<Node>("Cons5"), Names::Find<Node>("Cons6"), Names::Find<Node>("Cons7"), Names::Find<Node>("Cons8")};
  ...
  ndn::L3RateTracer::InstallAll("results/dataset/normal/DFN_topology/rate-trace-5.txt", Seconds(1));
  L2RateTracer::InstallAll("results/dataset/normal/DFN_topology/drop-trace-5.txt", Seconds(1));
